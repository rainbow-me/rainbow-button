...
import { UniqueTokenExpandedStateContent, ExpandedStateBackground, ExpandedState, Column, TitleText, Container, DownloadContainer, DownloadButton, XButtonWrapper } from '../styled';
